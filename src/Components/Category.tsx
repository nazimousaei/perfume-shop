...
export default function Category() {
  return (
    <div className="pt-16 px-14">
        ...
        <div className="mt-[11rem] mb-20  flex justify-center items-center relative">
          ...
          <div className="w-full flex flex-wrap sm:flex-nowrap justify-center items-center xl:px-24 gap-y-16 gap-5 lg:gap-10">
             <div className="w-full xsm:w-3/5 sm:w-[28%] rounded-tl-full rounded-tr-full shadow-2xl shadow-black/25">
             <img src="/img/pic-1.jpg" className="rounded-tl-full rounded-tr-full" alt='kids-perfume'/>
              <div className="flex justify-center font-semibold items-center 2xsm:text-xl xsm:text-2xl md:text-3xl title-shadow font-Dinar bg-white h-[6.5rem] md:h-[9rem]">
               عطر زنانه
              </div>
             </div>
             <div className="w-full xsm:w-3/5 sm:w-[28%] rounded-tl-full rounded-tr-full shadow-2xl shadow-black/25">
