...
export default function BasketItem(Props: basketItem) {
  ...
  return (
    <div className="flex items-center justify-between h-48 p-2.5 bg-zinc-50 relative  gap-x-2 rounded-lg shadow-lg shadow-black/10">
      ...
      <div className='flex justify-end items-center text-black  gap-x-1 xsm:gap-x-5 h-full '>
